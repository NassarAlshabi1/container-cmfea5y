...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cmfea5y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cmfea5y.containers.anotherwebservice.com/
...
```
git clone git@github.com:NassarAlshabi1/container-cmfea5y.git
cd container-cmfea5y
```
...
```
docker attach container-cmfea5y
```
